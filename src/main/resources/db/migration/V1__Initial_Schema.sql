...
CREATE TABLE IF NOT EXISTS capability_technologies (
    ...
    CONSTRAINT uk_capability_technology UNIQUE (capability_id, technology_id),
    CONSTRAINT fk_capability_technology_capability FOREIGN KEY (capability_id) REFERENCES capabilities(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
